...
function walkDir(dir) {
    ...
    for (const file of files) {
        ...
        if (fs.statSync(fullPath).isDirectory()) {
            ...
            content = content.replace(/container mx-auto px-6 max-w-5xl/g, 'page-container-narrow');

            // Special cases missed
            content = content.replace(/container mx-auto px-6 relative z-10 max-w-5xl/g, 'page-container-narrow relative z-10');
