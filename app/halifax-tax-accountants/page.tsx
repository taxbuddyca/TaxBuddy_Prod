...
export default function HalifaxLandingPage() {
    // Extract local FAQs
    const localFaqs = faqs.find(f => f.category === "Local & Regional (Halifax/NS)")?.items || [];
                    ...
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        >
                            <div className="inline-flex items-center gap-2 px-4 py-2 bg-growth/10 text-growth rounded-full text-xs font-black uppercase tracking-widest mb-6 border border-growth/20">
                                <MapPin size={14} /> Locally Based in Halifax, NS
                            </div>
                            <h1 className="text-4xl md:text-6xl font-black text-navy-950 leading-[0.95] tracking-tighter mb-8">
                                Best Tax Accountant <br />
                                <span className="text-growth italic">in Halifax, Nova Scotia.</span>
                            </h1>
                            <p className="text-xl text-navy-900/50 mb-10 leading-relaxed max-w-2xl mx-auto font-semibold tracking-tight">
                                Expert CPA-led virtual tax filing and bookkeeping for HRM residents and small businesses.
                                Get maximum savings without ever visiting an office.
                            </p>
                        </motion.div>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl mx-auto">
                            {[
                                ...
                                { label: "Halifax Based", icon: Building2 },
                    ...
                    <div className="max-w-4xl mx-auto">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
                            <motion.div
                                ...
                                viewport={{ once: true }}
                            >
                                <h2 className="text-3xl font-black text-navy-950 mb-6 tracking-tight">Expert Tax Preparation in Halifax & The HRM.</h2>
                                <p className="text-lg text-navy-900/60 leading-relaxed mb-6 font-medium">
                                    Why waste time driving to an office in <strong>Bedford</strong> or <strong>Dartmouth</strong> when you can file your taxes from your couch?
                                    TaxBuddy Canada is a Halifax-based virtual firm that specializes in modernizing the tax experience.
                                </p>
                                <p className="text-lg text-navy-900/60 leading-relaxed font-medium">
                                    We serve the entire <strong>Halifax Regional Municipality</strong>, including <strong>Sackville</strong>, <strong>Hammonds Plains</strong>,
                                    and <strong>Downtown Halifax</strong>. Our CPA-led team understands Nova Scotia's specific tax credits and provincial requirements,
                                    ensuring you maximize every deduction available to you.
                                </p>
                            </motion.div>
                            <motion.div
                                initial={{ opacity: 0, x: 20 }}
                            ...
                            >
                                <GlassCard className="p-8 border-growth/10" intensity="light">
                                    <h3 className="text-xl font-black text-navy-950 mb-4 flex items-center gap-3">
                                        <MapPin className="text-growth" size={20} /> Local Expertise
                                    </h3>
                                    <p className="text-navy-900/60 font-medium">We know the local business landscape in Nova Scotia and the Atlantic provinces.</p>
                                </GlassCard>
                                <GlassCard className="p-8 border-navy-950/5" intensity="light">
                                    <h3 className="text-xl font-black text-navy-950 mb-4 flex items-center gap-3">
                                        <ShieldCheck className="text-growth" size={20} /> CRA Compliance
                                    </h3>
                                    <p className="text-navy-900/60 font-medium">Our returns are audit-proof and filed electronically for the fastest refund.</p>
                                </GlassCard>
                            </motion.div>
                        </div>
                    </div>
            ...
            <section className="py-24 bg-navy-50/30">
                <div className="container mx-auto px-6">
                    <div className="max-w-4xl mx-auto text-center mb-16">
                        <span className="text-growth font-black uppercase tracking-[0.3em] text-[10px] mb-4 block">Regional Q&A</span>
                        <h2 className="text-3xl md:text-5xl font-black text-navy-950 mb-6 tracking-tight">Halifax Tax <span className="text-growth italic">Questions.</span></h2>
                        <p className="text-lg text-navy-900/50 font-medium">Find answers to the most common questions from Nova Scotia taxpayers.</p>
                    </div>
                    ...
                    <GlassCard className="max-w-5xl mx-auto p-12 md:p-20 text-center relative overflow-hidden bg-navy-950 border-navy-900" intensity="heavy">
                        <div className="relative z-10">
                            <h2 className="text-4xl md:text-6xl font-black text-white mb-8 tracking-tighter leading-[1.05]">
                                ...
                                <span className="text-growth">Halifax's best?</span>
                            </h2>
