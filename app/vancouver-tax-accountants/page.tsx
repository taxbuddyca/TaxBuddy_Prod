...
export default function VancouverLandingPage() {
    // Extract local FAQs
    const localFaqs = faqs.find(f => f.category === "Local & Regional (Vancouver/BC)")?.items || [];
                    ...
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        >
                            <div className="inline-flex items-center gap-2 px-4 py-2 bg-growth/10 text-growth rounded-full text-xs font-black uppercase tracking-widest mb-6 border border-growth/20">
                                <MapPin size={14} /> Virtual CPA Services in Vancouver & BC
                            </div>
                            <h1 className="text-4xl md:text-6xl font-black text-navy-950 leading-[0.95] tracking-tighter mb-8">
                                Best Tax Accountant <br />
                                <span className="text-growth italic">in Vancouver & The Lower Mainland.</span>
                            </h1>
                            <p className="text-xl text-navy-900/50 mb-10 leading-relaxed max-w-2xl mx-auto font-semibold tracking-tight">
                                Expert virtual tax filing and bookkeeping for Vancouver tech startups, creative professionals, and families.
                                Maximize your BC tax credits from the comfort of your home.
                            </p>
                        </motion.div>
                        ...
                        >
                            <Link href="/contact" className="group relative bg-navy-950 text-white px-10 py-5 rounded-2xl text-lg font-black hover:scale-105 transition-all flex items-center justify-center gap-3 shadow-2xl shadow-navy-950/20 focus:outline-none focus:ring-2 focus:ring-growth focus:ring-offset-2">
                                Start My BC Tax Return <ArrowRight size={20} className="group-hover:translate-x-1 transition-transform" />
                            </Link>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl mx-auto">
                            {[
                                ...
                                { label: "BC Expertise", icon: Building2 },
                                { label: "100% Virtual", icon: Globe },
                                { label: "Startup Friendly", icon: Star }
                            ].map((item, i) => (
                    ...
                    <div className="max-w-4xl mx-auto">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
                            <motion.div
                                ...
                                viewport={{ once: true }}
                            >
                                <h2 className="text-3xl font-black text-navy-950 mb-6 tracking-tight">Expert Tax Preparation in Vancouver & Beyond.</h2>
                                <p className="text-lg text-navy-900/60 leading-relaxed mb-6 font-medium">
                                    Avoid the traffic on the Lions Gate or the Oak Street Bridge. TaxBuddy Canada brings top-tier CPA expertise to your screen,
                                    serving <strong>Downtown Vancouver</strong>, <strong>Kitsilano</strong>, and the <strong>North Shore</strong>.
                                </p>
                                <p className="text-lg text-navy-900/60 leading-relaxed font-medium">
                                    We serve the entire <strong>Greater Vancouver area</strong>, including <strong>Burnaby</strong>, <strong>Richmond</strong>,
                                    and <strong>Surrey</strong>. Our virtual model is perfectly suited for BC's vibrant tech and creative industries.
                                </p>
                            </motion.div>
                            <motion.div
                                initial={{ opacity: 0, x: 20 }}
                            ...
                            >
                                <GlassCard className="p-8 border-growth/10" intensity="light">
                                    <h3 className="text-xl font-black text-navy-950 mb-4 flex items-center gap-3">
                                        <MapPin className="text-growth" size={20} /> BC Tax Logic
                                    </h3>
                                    <p className="text-navy-900/60 font-medium">We specialize in BC provincial credits, speculation tax compliance, and startup SR&ED filings.</p>
                                </GlassCard>
                                <GlassCard className="p-8 border-navy-950/5" intensity="light">
                                    <h3 className="text-xl font-black text-navy-950 mb-4 flex items-center gap-3">
                                        <ShieldCheck className="text-growth" size={20} /> CRA Compliance
                                    </h3>
                                    <p className="text-navy-900/60 font-medium">Our returns are audit-proof and E-Filed for the fastest possible refund processing.</p>
                                </GlassCard>
                            </motion.div>
                        </div>
                    </div>
            ...
            <section className="py-24 bg-navy-50/30">
                <div className="container mx-auto px-6">
                    <div className="max-w-4xl mx-auto text-center mb-16">
                        <span className="text-growth font-black uppercase tracking-[0.3em] text-[10px] mb-4 block">BC Regional Q&A</span>
                        <h2 className="text-3xl md:text-5xl font-black text-navy-950 mb-6 tracking-tight">Vancouver Tax <span className="text-growth italic">Questions.</span></h2>
                        <p className="text-lg text-navy-900/50 font-medium">Find answers to the most common questions from British Columbia taxpayers.</p>
                    </div>
                    ...
                    <GlassCard className="max-w-5xl mx-auto p-12 md:p-20 text-center relative overflow-hidden bg-navy-950 border-navy-900" intensity="heavy">
                        <div className="relative z-10">
                            <h2 className="text-4xl md:text-6xl font-black text-white mb-8 tracking-tighter leading-[1.05]">
                                ...
                                <span className="text-growth">Vancouver's best?</span>
                            </h2>
                            <p className="text-xl text-white/50 mb-12 max-w-2xl mx-auto font-medium leading-relaxed">
                                Join hundreds of BC entrepreneurs and families who have discovered a faster, more professional way to manage their taxes virtually.
                            </p>
