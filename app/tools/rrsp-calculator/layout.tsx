...
export const metadata: Metadata = {
    title: '2025 RRSP Contribution & Tax Savings Calculator | TaxBuddy',
    description: 'Calculate your RRSP contribution room and see exactly how much you can save on your 2025 Canadian taxes. Free RRSP deduction calculator to maximize your refund.',
    ...
    openGraph: {
        title: '2025 RRSP Tax Savings Calculator | TaxBuddy',
