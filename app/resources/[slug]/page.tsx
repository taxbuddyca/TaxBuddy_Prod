                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="max-w-3xl mb-16">
                        ...
                        {slug === 'tax-checklist' && (
                            <button
                                onClick={handlePrint}
                                className="no-print inline-flex items-center gap-3 px-8 py-4 bg-navy-950 text-white rounded-2xl font-black text-sm uppercase tracking-widest hover:scale-105 transition-all shadow-premium"
                            >
                        ...
                        <div className="space-y-6 sticky top-32 no-print">
                            <div className="bg-navy-950 text-white rounded-[3rem] p-10 relative overflow-hidden group shadow-premium">
                                ...
                                <div className="relative z-10">
                                    ...
                                    <Link href="/contact" className="inline-flex h-14 px-8 bg-blue-600 text-white rounded-2xl font-black items-center justify-center gap-3 hover:scale-105 transition-all w-full shadow-lg">
                            ...
                            <div className="flex flex-col gap-2">
                                <Link href="/tools/tax-calculator" className="flex items-center justify-between p-4 bg-white border border-gray-100 rounded-2xl hover:border-blue-600 transition-all font-black text-xs uppercase tracking-tight text-navy-950 group">
                                    Income Tax Calculator <ArrowRight size={14} className="text-blue-600 group-hover:translate-x-1 transition-transform" />
                                </Link>
                                <Link href="/tools/rrsp-calculator" className="flex items-center justify-between p-4 bg-white border border-gray-100 rounded-2xl hover:border-blue-600 transition-all font-black text-xs uppercase tracking-tight text-navy-950 group">
