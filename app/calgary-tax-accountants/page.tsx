...
export default function CalgaryLandingPage() {
    // Extract local FAQs
    const localFaqs = faqs.find(f => f.category === "Local & Regional (Calgary/AB)")?.items || [];
                    ...
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        >
                            <div className="inline-flex items-center gap-2 px-4 py-2 bg-growth/10 text-growth rounded-full text-xs font-black uppercase tracking-widest mb-6 border border-growth/20">
                                <MapPin size={14} /> Virtual Expert in Calgary & Alberta
                            </div>
                            <h1 className="text-4xl md:text-6xl font-black text-navy-950 leading-[0.95] tracking-tighter mb-8">
                                Top Tax Accountant <br />
                                <span className="text-growth italic">in Calgary & The Prairies.</span>
                            </h1>
                            <p className="text-xl text-navy-900/50 mb-10 leading-relaxed max-w-2xl mx-auto font-semibold tracking-tight">
                                CPA-led virtual tax filing and bookkeeping for Calgary entrepreneurs, energy sector professionals, and small businesses.
                                Maximize your Alberta tax savings without the office visit.
                            </p>
                        </motion.div>
                        ...
                        >
                            <Link href="/contact" className="group relative bg-navy-950 text-white px-10 py-5 rounded-2xl text-lg font-black hover:scale-105 transition-all flex items-center justify-center gap-3 shadow-2xl shadow-navy-950/20 focus:outline-none focus:ring-2 focus:ring-growth focus:ring-offset-2">
                                Start My Alberta Tax Return <ArrowRight size={20} className="group-hover:translate-x-1 transition-transform" />
                            </Link>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl mx-auto">
                            {[
                                ...
                                { label: "Alberta Focus", icon: Building2 },
                                { label: "100% Virtual", icon: Globe },
                                { label: "Fast Returns", icon: Star }
                            ].map((item, i) => (
                    ...
                    <div className="max-w-4xl mx-auto">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
                            <motion.div
                                ...
                                viewport={{ once: true }}
                            >
                                <h2 className="text-3xl font-black text-navy-950 mb-6 tracking-tight">Expert Tax Preparation for Calgary Businesses.</h2>
                                <p className="text-lg text-navy-900/60 leading-relaxed mb-6 font-medium">
                                    From <strong>Downtown Calgary</strong> and the <strong>Beltline</strong> to <strong>Airdrie</strong> and <strong>Okotoks</strong>,
                                    TaxBuddy Canada is your virtual partner for navigating Alberta's provincial and federal tax obligations.
                                </p>
                                <p className="text-lg text-navy-900/60 leading-relaxed font-medium">
                                    We serve the entire <strong>Calgary Region</strong>, including <strong>Edmonton</strong> and <strong>Red Deer</strong>.
                                    Our virtual CPA model is built for the busy Alberta entrepreneur who values professional results over traditional overhead.
                                </p>
                            </motion.div>
                            <motion.div
                                initial={{ opacity: 0, x: 20 }}
                            ...
                            >
                                <GlassCard className="p-8 border-growth/10" intensity="light">
                                    <h3 className="text-xl font-black text-navy-950 mb-4 flex items-center gap-3">
                                        <MapPin className="text-growth" size={20} /> Alberta Specifics
                                    </h3>
                                    <p className="text-navy-900/60 font-medium">We specialize in Alberta-specific personal and corporate tax credits, including the Alberta Child and Family Benefit.</p>
                                </GlassCard>
                                <GlassCard className="p-8 border-navy-950/5" intensity="light">
                                    <h3 className="text-xl font-black text-navy-950 mb-4 flex items-center gap-3">
                                        <ShieldCheck className="text-growth" size={20} /> Audit Protected
                                    </h3>
                                    <p className="text-navy-900/60 font-medium">Our expert review process ensures your returns are 100% compliant with CRA standards, reducing your risk of audit.</p>
                                </GlassCard>
                            </motion.div>
                        </div>
                    </div>
            ...
            <section className="py-24 bg-navy-50/30">
                <div className="container mx-auto px-6">
                    <div className="max-w-4xl mx-auto text-center mb-16">
                        <span className="text-growth font-black uppercase tracking-[0.3em] text-[10px] mb-4 block">Alberta Q&A</span>
                        <h2 className="text-3xl md:text-5xl font-black text-navy-950 mb-6 tracking-tight">Calgary Tax <span className="text-growth italic">Questions.</span></h2>
                        <p className="text-lg text-navy-900/50 font-medium">Find answers to common tax questions from Calgary and Alberta taxpayers.</p>
                    </div>
                    ...
                    <GlassCard className="max-w-5xl mx-auto p-12 md:p-20 text-center relative overflow-hidden bg-navy-950 border-navy-900" intensity="heavy">
                        <div className="relative z-10">
                            <h2 className="text-4xl md:text-6xl font-black text-white mb-8 tracking-tighter leading-[1.05]">
                                ...
                                <span className="text-growth">Calgary's best?</span>
                            </h2>
                            <p className="text-xl text-white/50 mb-12 max-w-2xl mx-auto font-medium leading-relaxed">
                                Join hundreds of Calgary entrepreneurs who have switched to a better, faster, and more professional way to file taxes virtually.
                            </p>
                            <div className="flex flex-col sm:flex-row gap-6 justify-center">
                                <Link href="/contact" className="bg-growth text-white px-10 py-5 rounded-2xl text-lg font-black hover:scale-105 transition-all inline-flex items-center justify-center gap-3 shadow-2xl shadow-growth/20 focus:outline-none focus:ring-2 focus:ring-growth focus:ring-offset-2">
                                    Book a Calgary Consultation <Send size={20} />
                                </Link>
