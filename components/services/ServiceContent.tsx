    ...
    return (
        <div className="space-y-16">
            ...
            {content.faqs && content.faqs.length > 0 && (
                <section className="py-12 bg-growth/5 rounded-[2.5rem] p-10 md:p-14 border border-growth/10">
                    <div className="flex items-center gap-4 mb-10">
                        <div className="w-12 h-12 bg-growth text-white rounded-2xl flex items-center justify-center shadow-lg shadow-growth/20">
                            <HelpCircle size={24} />
                        </div>
                        <h2 className="text-3xl font-black text-navy-950">Service Specific Q&A</h2>
                    </div>
