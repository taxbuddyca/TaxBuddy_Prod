 ...
 *  1. Continuous gentle float/bob animation
 *  2. Rotating shimmer sweep that flashes across the leaf every 3s
 *  3. Subtle sparkle pulse on the top tip
 */
export default function Logo({ className = "w-8 h-8" }: { className?: string }) {
    return (
        ...
        >
            ...
            {/* ===== LEAF GROUP — floating animation ===== */}
            <g>
                {/* Float bob animation applied to entire leaf */}
                <animateTransform
                ...
                <g transform="rotate(-12, 200, 210)">
                    ...
                    <circle cx="200" cy="18" r="6" fill="white" opacity="0">
                        <animate
